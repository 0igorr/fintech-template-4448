              ...
              <div className="bg-gray-50">
                ...
                <div className="flex items-center justify-between mb-6 min-w-0 my-[10px]">
                  ...
                  <div className="flex items-center gap-2 flex-shrink-0">
                    ...
                    <div className="h-8 px-3 rounded-md text-white flex items-center justify-center text-sm font-medium whitespace-nowrap transition-all duration-300 cursor-pointer bg-gradient-to-r from-orange-500 to-yellow-500 shadow-lg hover:shadow-xl my-0 mx-[20px]">Nova Automação</div>
                  </div>
                </div>
